...
The anvil pump can extract compressed air from the air when the six faces of a drain are not blocked. Compressed air is only about 1 MPa, so it must be further input into a large tank to liquefy.
