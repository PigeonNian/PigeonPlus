...
Compressed air can only be drawn from a drain whose six faces are **not fully sealed** (pipes and the pump itself are ignored for this check). Air enters the fluid network through the pump and diffuses onward to tanks and other containers.
